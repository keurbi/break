    ...
    <div className="fixed inset-0 backdrop-blur-md flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-[95vh] overflow-y-auto">
        ...
        <div className="p-4 space-y-4">
          ...
          {/* Benefits et Tips et Resource en grid compact */}
          ...
          {/* Resource et Tags sur une ligne */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            {/* Resource */}
            {activity.resource && (
              <div>
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
                  {activity.resource.startsWith("http") ? (
                    ...
                    <p className="text-gray-700 text-sm">{activity.resource}</p>
                  )}
                </div>
              </div>
            )}
            ...
            {activity.tags && activity.tags.length > 0 && (
              <div>
                <h3 className="text-base font-semibold text-gray-800 mb-2">Tags</h3>
        ...
        <div className="p-4 border-t border-gray-200 bg-gray-50 rounded-b-xl">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={onStart}
              className="px-6 py-2 bg-[#7346FF] text-white rounded-lg font-semibold hover:bg-[#5f39d9] transition-colors flex items-center space-x-2 text-sm"
            >
              <span>🚀</span>
