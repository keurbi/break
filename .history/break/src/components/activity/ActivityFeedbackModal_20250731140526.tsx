  ...
  const renderSlider = (
    ...
    <div className="mb-6">
      ...
      <input
        ...
        style={{
          background: `linear-gradient(to right, #7346FF 0%, #7346FF ${((feedback[field] - min) / (max - min)) * 100}%, #e5e7eb ${((feedback[field] - min) / (max - min)) * 100}%, #e5e7eb 100%)`
        }}
      />
      ...
      <div className="bg-white rounded-xl shadow-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-xl font-bold text-gray-800">Feedback de l'activité</h2>
