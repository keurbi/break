      ...
      <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold text-blue-800">{activity.duration} min</p>
                </div>
              </div>
            </div>
            <div className={`border rounded-lg p-4 ${getDifficultyColor(activity.difficulty)}`}>
              <div className="flex items-center space-x-2">
                <span className="text-xl">📊</span>
                <div>
                  <p className="text-sm font-medium">Difficulté</p>
                  <p className="text-lg font-bold">{getDifficultyText(activity.difficulty)}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {activity.tips && activity.tips.length > 0 && (
            <div>
              <h3 className="text-lg font-semibold text-gray-800 mb-3">Conseils</h3>
          ...
          {activity.resource && (
            <div>
              <h3 className="text-lg font-semibold text-gray-800 mb-3">Ressource</h3>
