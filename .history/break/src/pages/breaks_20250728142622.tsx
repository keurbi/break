    ...
    <Layout>
      <PageContainer>
        ...
        <div className="flex flex-col items-center justify-center min-h-screen py-2 relative">
          <div className="flex flex-row items-center justify-center w-full max-w-6xl mx-auto mt-2 mb-16 gap-12">
            <div className="flex flex-col items-center flex-[1.5] mt-12 justify-center">
              <div
                ...
                style={{ maxWidth: 700, fontSize: '7rem', letterSpacing: '0.08em', lineHeight: 1.1, wordBreak: 'keep-all', whiteSpace: 'nowrap' }}
              >
