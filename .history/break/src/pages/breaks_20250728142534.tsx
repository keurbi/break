        ...
        <div className="flex flex-col items-center justify-start min-h-screen py-2 relative">
          <div className="flex flex-row items-start w-full max-w-6xl mx-auto mt-2 mb-16 gap-12">
            <div className="flex flex-col items-center flex-[1.5] mt-12">
              <div
                className="font-bold text-[#7346FF] bg-white px-48 py-16 rounded-lg mb-10 shadow border-[#7346FF] w-full text-center"
                style={{ maxWidth: 700, margin: "0 auto", fontSize: '7rem', letterSpacing: '0.08em', lineHeight: 1.1, wordBreak: 'keep-all', whiteSpace: 'nowrap' }}
              >
            ...
            <div className="flex-1 flex flex-col justify-start mt-12">
              <table
                className="w-full min-w-[540px] text-2xl bg-white rounded-2xl shadow-lg"
                style={{ maxWidth: 700 }}
              >
                <thead>
                  <tr>
                ...
                <tbody>
                  {todayBreaks.map((b, idx) => {
                    ...
                    if (b.end) {
                      ...
                      duration = `${min.toString().padStart(2, "0")} min ${sec
                        .toString()
                        .padStart(2, "0")} s`;
                    }
